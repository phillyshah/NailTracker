...
import { Package, Users, AlertTriangle, Clock, XCircle, Inbox } from 'lucide-react';
import { getSummary, getExpiring, getDistributorCounts } from '../api/reports';
...
export default function Reports() {
  ...
  const metrics = [
    ...
    { label: 'Expiring < 90d', value: summary?.expiring90 ?? '—', icon: AlertTriangle, color: 'bg-amber-50 text-amber-700' },
    { label: 'Expiring < 180d', value: summary?.expiring180 ?? '—', icon: Clock, color: 'bg-yellow-50 text-yellow-700' },
