...
## v3.28 — 2026-06-06
- **Transfer page redesigned to mirror the Receive experience, with a new "Manual Transfer" mode.** A **"Pick from list / Manual Transfer"** toggle now sits above the From/To selectors. Pick-from-list is unchanged. Manual Transfer brings the Receive-style input cards to transfers — **Live Scan**, **Take Photo**, **Upload Photo**, **Batch Photos**, **Import CSV/Excel**, and **Manual Entry** (paste a QR/barcode string, or type Item Number / Lot / Expiry + quantity) — purpose-built for quick transfers of a few parts without a spreadsheet.
